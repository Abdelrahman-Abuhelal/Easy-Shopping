...
Posting Order Request with the product Ids, quantity and customer email and name.
![Screenshot (2)](https://user-images.githubusercontent.com/77440941/211189277-f4a3ee11-cb43-4f94-b7ab-46676478bf18.png)

Then the total amount will be calculated and returned with invouce number as a response to the customer
